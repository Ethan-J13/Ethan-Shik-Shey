...
Now, you will see the six text layers, <Samurai>, <Samurai copy>, <Last>, <Last copy>, <The>,
and <The copy>
...
Nice job! You've done it! If you want to change the text size, you need to change the size of the original layer and the copy layer together. Select one layer, hold down the Control key, and click another layer to select both layers. And then, changing the font size will apply to both layers. In the same way, you can change the position of the two layers simultaneously, so please try it.
